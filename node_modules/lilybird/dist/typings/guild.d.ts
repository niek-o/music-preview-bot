...
import type { DefaultMessageNotificationLevel, GuildScheduledEventPrivacyLevel, GuildScheduledEventEntityType, ExplicitContentFilterLevel, GuildScheduledEventStatus, IntegrationExpireBehavior, VerificationLevel, VideoQualityMode, IntegrationType, ForumLayoutType, GuildNSFWLevel, OnboardingMode, SortOrderType, PremiumTier, ChannelType, PromptType, MFALevel, Locale } from "#enums";
...
export declare namespace Guild {
    ...
    interface New extends Structure {
        joined_at: string;
        large: boolean;
        unavailable?: boolean;
        member_count: number;
    ...
    interface WidgetSettingsStructure {
        enabled: boolean;
    ...
    interface OnboardingPromptStructure {
        id: string;
        type: PromptType;
    ...
    interface PromptOptionStructure {
        id: string;
    ...
    interface ScheduledEventStructure {
        id: string;
        guild_id: string;
        channel_id: string | null;
    ...
    namespace Create {
        ...
        interface GuildChannelJSONParams {
            reason?: string;
            name: string;
        ...
        interface ScheduledEventJSONParams {
            reason?: string;
            channel_id?: string;
    ...
    namespace Modify {
        ...
        interface ChannelPositionJSONParams {
            id: string;
            position?: number | null;
