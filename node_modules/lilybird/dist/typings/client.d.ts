...
import type { ApplicationCommandPermissionsUpdate, AutoModerationActionExecution, GuildScheduledEventUserRemove, GuildScheduledEventUserAdd, MessageReactionRemoveEmoji, GuildScheduledEventCreate, GuildScheduledEventDelete, GuildScheduledEventUpdate, AutoModerationRuleCreate, AutoModerationRuleDelete, AutoModerationRuleUpdate, GuildAuditLogEntryCreate, MessageReactionRemoveAll, UpdatePresenceStructure, GuildIntegrationsUpdate, MessageReactionRemove, MessagePollVoteRemove, ReceiveDispatchEvent, GuildStickersUpdate, StageInstanceCreate, StageInstanceUpdate, ThreadMembersUpdate, MessageReactionAdd, MessagePollVoteAdd, ThreadMemberUpdate, MessageDeleteBulk, IntegrationCreate, IntegrationDelete, IntegrationUpdate, InteractionCreate, VoiceServerUpdate, ChannelPinsUpdate, GuildMemberRemove, GuildEmojisUpdate, GuildMemberUpdate, GuildMembersChunk, VoiceStateUpdate, GuildRoleCreate, GuildRoleUpdate, PresenceUpdate, ThreadListSync, GuildRoleDelete, GuildMemberAdd, GuildBanRemove, MessageCreate, MessageDelete, ChannelCreate, ChannelDelete, ChannelUpdate, MessageUpdate, WebhookUpdate, InviteCreate, InviteDelete, ThreadCreate, ThreadDelete, ThreadUpdate, GuildBanAdd, GuildCreate, GuildDelete, GuildUpdate, TypingStart, UserUpdate, Ready } from "./gateway-events.js";
export type ClientListeners<T extends Transformers> = {
    [K in keyof T]?: T[K] extends {
        handler: unknown;
    } ? (T[K] & {})["handler"] extends ((...args: any) => infer R) ? R extends [unknown, ...Array<unknown>] ? ((...arg: R) => Awaitable<unknown>) : ((arg: R) => Awaitable<unknown>) : never : (T[K] & {
        handler: unknown;
    })["handler"] extends ((...args: infer U) => unknown) ? ((...args: U) => Awaitable<unknown>) : never;
};
...
export type ParseCachingManager<T extends ClientOptions<Transformers>> = T["caching"] extends {} ? T["caching"]["applyTransformers"] extends true ? T["caching"] extends {
    transformerTypes: (infer U extends CacheWithTransformers["transformerTypes"]);
} ? CachingManager<U["guild"], U["channel"], U["voiceState"]> : never : T["caching"]["delegate"] extends CachingDelegationType.EXTERNAL ? T["caching"]["manager"] & {} : CachingManager : never;
